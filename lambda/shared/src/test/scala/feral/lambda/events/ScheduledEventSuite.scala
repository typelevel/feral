...
class ScheduledEventSuite extends FunSuite {
  ...
  private def singleMetricResult: ScheduledEvent = ScheduledEvent(
    ...
    detail = JsonObject.apply(
      ...
      "configuration" -> JsonObject.apply(
        ...
        "metrics" -> Json.arr(
          JsonObject.apply(
            ...
            "metricStat" -> JsonObject.apply(
              "metric" -> JsonObject.apply(
                "dimensions" -> JsonObject.apply("InstanceId" -> Json.fromString("i-12345678901234567")).toJson,
      ...
      "previousState" -> JsonObject.apply(
      ...
      "state" -> JsonObject.apply(
        ...
        "reasonData" -> Json.fromString("{\"version\":\"1.0\",\"queryDate\":\"2019-10-02T17:04:40.985+0000\",\"startDate\":\"2019-10-02T16:59:00.000+0000\",\"statistic\":\"Average\",\"period\":300,\"recentDatapoints\":[99.50160229693434],\"threshold\":50.0}"),
  ...
  private def abnormalityDetectionResult: ScheduledEvent = ScheduledEvent(
    ...
    detail = JsonObject.apply(
      ...
      "previousState" -> JsonObject.apply(
        "value" -> Json.fromString("OK"),
        "reason" -> Json.fromString("Thresholds Crossed: 1 out of the last 1 datapoints [0.166666666664241 (03/10/19 15:57:00)] was not less than the lower thresholds [0.0206719426210418] or not greater than the upper thresholds [0.30076870222143803] (minimum 1 datapoint for ALARM -> OK transition)."),
        "reasonData" -> Json.fromString("{\"version\":\"1.0\",\"queryDate\":\"2019-10-03T15:59:04.670+0000\",\"startDate\":\"2019-10-03T15:57:00.000+0000\",\"period\":60,\"recentDatapoints\":[0.166666666664241],\"recentLowerThresholds\":[0.0206719426210418],\"recentUpperThresholds\":[0.30076870222143803]}"),
  ...
  private def compoundAlarmSuppressorResult: ScheduledEvent = ScheduledEvent(
    ...
    detail = JsonObject.apply(
      ...
      "configuration" -> JsonObject.apply(
        "alarmRule" -> Json.fromString("ALARM(ServerCpuTooHigh) OR ALARM(TotalNetworkTrafficTooHigh)"),
