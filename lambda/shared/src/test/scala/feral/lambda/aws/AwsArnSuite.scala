...
class AwsArnSuite extends FunSuite {
  ...
  test("AwsArn should parse DynamoDB ARN") {
    val dynamoArn = "arn:aws:dynamodb:us-west-2:account-id:table/ExampleTableWithStream/stream/2015-06-27T00:48:05.899"
    ...
    assertEquals(AwsArn.resource(arn), Some("table/ExampleTableWithStream/stream/2015-06-27T00:48:05.899"))
  }
